...
public interface EnvioRepository extends JpaRepository<Envio, Integer> {
        ...
        /**
         * Envios con partes asignadas (fetch parts) para inicialización del
         * planificador.
         */
        ...
        // Native para incluir NULL de forma explícita (COALESCE)
        @Query(value = "SELECT COALESCE(estado, 'NULL') AS estado, COUNT(*) AS cantidad " +
                        "FROM envio " +
                        "GROUP BY estado", nativeQuery = true)
        List<Object[]> contarPorEstadoIncluyendoNull();
